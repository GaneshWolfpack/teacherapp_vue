				...
				<nav class="navbar navbar-expand-lg header-nav">
					<div class="container-fluid">
						...
						<ul class="nav header-navbar-rht">
							<li class="nav-item">
								<a class="nav-link header-login" href="/teacher">Teacher</a>
							</li>
							<li class="nav-item">
								<a class="nav-link header-login" href="/student">Student</a>
							</li>
						</ul>
                        <ul class="nav header-navbar-rht">
							<li class="nav-item">
								<a class="nav-link header-register" href="/">Login</a>
							</li>
							<li class="nav-item">
								<a class="nav-link header-login" href="/sign-up">Register</a>
							</li>
						</ul>
					</div>
				</nav>
							...
							<div class="popular-course">
								...
								<div class="courses-footer d-flex align-items-center">
									<div class="courses-count">
										<ul class="mb-0">
											<li><i class="fas fa-user-graduate ml-1"></i> 85</li>
											<li><i class="far fa-file-alt ml-1"></i>5</li>
										</ul>
									</div>
									<div class="courses-amt mr-auto">
						...
						<div class="col-lg-3 col-md-6 col-sm-12 d-flex flex-wrap">
							<div class="popular-course">
								...
								<div class="courses-footer d-flex align-items-center">
									<div class="courses-count">
										<ul class="mb-0">
											<li><i class="fas fa-user-graduate ml-1"></i> 125</li>
											<li><i class="far fa-file-alt ml-1"></i>3</li>
										</ul>
									</div>
									<div class="courses-amt mr-auto">
						...
						<div class="col-lg-3 col-md-6 col-sm-12 d-flex flex-wrap">
							<div class="popular-course">
								...
								<div class="courses-footer d-flex align-items-center">
									<div class="courses-count">
										<ul class="mb-0">
											<li><i class="fas fa-user-graduate ml-1"></i> 122</li>
											<li><i class="far fa-file-alt ml-1"></i>2</li>
										</ul>
									</div>
									<div class="courses-amt mr-auto">
						...
						<div class="col-lg-3 col-md-6 col-sm-12 d-flex flex-wrap">
							<div class="popular-course">
								...
								<div class="courses-footer d-flex align-items-center">
									<div class="courses-count">
										<ul class="mb-0">
											<li><i class="fas fa-user-graduate ml-1"></i> 320</li>
											<li><i class="far fa-file-alt ml-1"></i>8</li>
										</ul>
									</div>
									<div class="courses-amt mr-auto">
						...
						<div class="col-lg-3 col-md-6 col-sm-12 d-flex flex-wrap">
							<div class="popular-course">
								...
								<div class="courses-footer d-flex align-items-center">
									<div class="courses-count">
										<ul class="mb-0">
											<li><i class="fas fa-user-graduate ml-1"></i> 215</li>
											<li><i class="far fa-file-alt ml-1"></i>3</li>
										</ul>
									</div>
									<div class="courses-amt mr-auto">
						...
						<div class="col-lg-3 col-md-6 col-sm-12 d-flex flex-wrap">
							<div class="popular-course">
								...
								<div class="courses-footer d-flex align-items-center">
									<div class="courses-count">
										<ul class="mb-0">
											<li><i class="fas fa-user-graduate ml-1"></i> 128</li>
											<li><i class="far fa-file-alt ml-1"></i>2</li>
										</ul>
									</div>
									<div class="courses-amt mr-auto">
						...
						<div class="col-lg-3 col-md-6 col-sm-12 d-flex flex-wrap">
							<div class="popular-course">
								...
								<div class="courses-footer d-flex align-items-center">
									<div class="courses-count">
										<ul class="mb-0">
											<li><i class="fas fa-user-graduate ml-1"></i> 354</li>
											<li><i class="far fa-file-alt ml-1"></i>8</li>
										</ul>
									</div>
									<div class="courses-amt mr-auto">
						...
						<div class="col-lg-3 col-md-6 col-sm-12 d-flex flex-wrap">
							<div class="popular-course">
								...
								<div class="courses-footer d-flex align-items-center">
									<div class="courses-count">
										<ul class="mb-0">
											<li><i class="fas fa-user-graduate ml-1"></i> 200</li>
											<li><i class="far fa-file-alt ml-1"></i>2</li>
										</ul>
									</div>
									<div class="courses-amt mr-auto">
								...
								<div class="col-lg-6">
									<div class="subscribe-item">
										<form class="newsletter-form">
											...
											<button class="btn cmn-btn disabled" type="submit"><i class="fas fa-paper-plane ml-2"></i>Subscribe Now</button>
										</form>
									</div>
								</div>
							</div>
					...
					<div class="container">
						...
						<div class="copyright">
							<div class="row">
								...
								<div class="col-md-6 col-12">
									<div class="copyright-text text-md-left">
...
export default {
  ...
  mounted() {
    document.title = 'Teacherapp | Index'
  },
  methods: {
  },
  logout() {
